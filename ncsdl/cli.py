...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--show-empty", action="store_true", help="Show genres with zero results (requires -v)")
    ...
    # check-dupes
    p = subparsers.add_parser("check-dupes", help="Check for duplicate songs in a directory")
